...
// PDO connect *********
function connect() {
    return new PDO('mysql:host=localhost;dbname=u813372400_trave', 'u813372400_admin', 'Admin;', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
}
